 ...
 */
@Deprecated
public class ElasticSearchTransportClientExt implements ElasticSearchClient {

	public static final Logger logger = LoggerFactory.getLogger(ElasticSearchTransportClientExt.class);
	 ...
	 * @param serializer
	 */
	public ElasticSearchTransportClientExt(String[] hostNames, String clusterName,
	 ...
	 */
	public ElasticSearchTransportClientExt(ElasticSearchIndexRequestBuilderFactory indexBuilderFactory) {
	 ...
	 * @param serializer
	 */
	public ElasticSearchTransportClientExt(ElasticSearchEventSerializer serializer) {
		this.serializer = serializer;
		openLocalDiscoveryClient();
	}
	 ...
	 *            Event Serializer
	 */
	public ElasticSearchTransportClientExt(Client client, ElasticSearchEventSerializer serializer) {
		this.client = client;
		this.serializer = serializer;
	}
	 ...
	 * Used for testing
	 */
	public ElasticSearchTransportClientExt(Client client, ElasticSearchIndexRequestBuilderFactory requestBuilderFactory)
			throws IOException {
		this.client = client;
	...
	public void addEvent(Event event, IndexNameBuilder indexNameBuilder, String indexType, long ttlMs)
		...
		if (indexRequestBuilderFactory == null) {
			...
			serializer.getContentBuilder(event);
			// indexRequestBuilder =
			// client.prepareIndex(indexNameBuilder.getIndexName(event),
			// indexType)
