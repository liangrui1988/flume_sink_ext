...
public class EsRestClientExt implements ElasticSearchClient {
	 ...
	 * @return
	 */
	public static RestClient getRestClint(String httpHost, Integer port, String username, String password) {
...
//			bulkBuilder.append(content.toBytesArray().toUtf8());
	...
	public void execute() throws Exception {
		...
		while (statusCode != HttpStatus.SC_OK && triesCount < serversList.size()) {//失败重复提交
			...
			response = getRestClint(host, port, username, password).performRequest("POST", "/" + BULK_ENDPOINT,
